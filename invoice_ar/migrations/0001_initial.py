...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='invoicear',
            name='vat_subtotals',
            field=models.ManyToManyField(related_name='_invoicear_vat_subtotals_+', related_query_name='invoicear', to='invoice_ar.InvoiceARHasSubtotalVAT', verbose_name='VAT subtotals'),
        ),
