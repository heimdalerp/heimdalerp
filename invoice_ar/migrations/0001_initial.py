...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('invoice_company', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='invoice.CompanyInvoice', verbose_name='company')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('invoice_contact', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='invoice.ContactInvoice', verbose_name='contact')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_type', models.CharField(choices=[('P', 'Product'), ('S', 'Service'), ('PS', 'Product and service')], max_length=2, verbose_name='service type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('afip_code', models.SmallIntegerField(unique=True, verbose_name='AFIP code')),
            ],
            options={
                'default_permissions': ('view', 'add', 'change', 'delete'),
