    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('due_date', models.DateField(validators=[common.validators.date_is_present_or_future], verbose_name='due date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fiscal_address', models.ForeignKey(db_index=False, on_delete=django.db.models.deletion.PROTECT, related_name='point_of_sales', related_query_name='point_of_sale', to='persons.PhysicalAddress', verbose_name='fiscal address')),
