    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.TextField(blank=True, default='', verbose_name='private key')),
                ('cert', models.TextField(blank=True, default='', verbose_name='certificate')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cae', models.CharField(blank=True, default='', max_length=12, verbose_name='CAE')),
                ('cae_expires', models.DateField(blank=True, null=True, verbose_name='CAE expires')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vat', models.ForeignKey(db_index=False, on_delete=django.db.models.deletion.PROTECT, related_name='+', related_query_name='+', to='invoice.VAT', verbose_name='VAT')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fiscal_address', models.ForeignKey(db_index=False, on_delete=django.db.models.deletion.PROTECT, related_name='point_of_sales_ar', related_query_name='point_of_sale_ar', to='persons.PhysicalAddress', verbose_name='fiscal address')),
                ('invoicear_company', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='point_of_sales_ar', related_query_name='point_of_sale_ar', to='invoice_ar.CompanyInvoiceAR', verbose_name='company')),
            ],
            options={
                'verbose_name_plural': 'point of sales AR',
                'verbose_name': 'point of sale AR',
                'default_permissions': ('view', 'add', 'change', 'delete'),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('begin', models.CharField(max_length=50, verbose_name='expiration')),
                ('generation', models.CharField(max_length=50, verbose_name='generation')),
                ('expiration', models.CharField(max_length=50, verbose_name='expiration')),
                ('token', models.TextField(verbose_name='token')),
                ('sign', models.TextField(verbose_name='sign')),
                ('invoicear_company', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='+', related_query_name='+', to='invoice_ar.CompanyInvoiceAR', verbose_name='company')),
            ],
            options={
                'verbose_name_plural': 'webservice sessions',
                'verbose_name': 'webservice session',
                'default_permissions': ('view', 'add', 'change', 'delete'),
            },
        ),
        migrations.AddField(
            model_name='invoicear',
            name='point_of_sale_ar',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='invoices_ar', related_query_name='invoice_ar', to='invoice_ar.PointOfSaleAR', verbose_name='point of sale AR'),
        ),
        migrations.AddField(
            model_name='invoicear',
            name='vat_subtotals',
