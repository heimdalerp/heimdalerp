    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('concept_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invoices', related_query_name='invoice', to='invoice_ar.ConceptType', verbose_name='concept type')),
                ('invoicear_company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invoices', related_query_name='invoice', to='invoice_ar.CompanyInvoiceAR', verbose_name='company AR')),
                ('invoicear_contact', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invoices', related_query_name='invoice', to='invoice_ar.ContactInvoiceAR', verbose_name='contact AR')),
            ],
            options={
