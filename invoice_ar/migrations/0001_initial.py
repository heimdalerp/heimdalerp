    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoicear_company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='point_of_sales_ar', related_query_name='point_of_sale_ar', to='invoice_ar.CompanyInvoiceAR', verbose_name='company')),
            ],
            options={
                'default_permissions': ('view', 'add', 'change', 'delete'),
