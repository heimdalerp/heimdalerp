    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='physical_addresses', related_query_name='physical_address', to='cities.City', verbose_name='city')),
            ],
            options={
