...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', related_query_name='contact_invoice', to='accounting.Account', verbose_name='invoice account'),
        ),
        migrations.AddField(
