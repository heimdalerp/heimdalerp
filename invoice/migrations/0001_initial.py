    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice_credit_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invoices_credit', related_query_name='invoice_credit', to='accounting.Account', verbose_name='invoice debit account')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount', models.FloatField(blank=True, default=0.0, help_text='A number between 0.00 and 1.00', verbose_name='discount')),
        ...
        migrations.AlterUniqueTogether(
            name='invoice',
            unique_together=set([('invoice_company', 'invoice_type', 'number')]),
        ),
    ]
