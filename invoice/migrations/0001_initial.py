    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice_contact', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invoices', related_query_name='invoice', to='invoice.ContactInvoice', verbose_name='contact')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='invoice',
            name='transaction',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', related_query_name='+', to='accounting.Transaction', verbose_name='transaction'),
        ),
        migrations.AddField(
