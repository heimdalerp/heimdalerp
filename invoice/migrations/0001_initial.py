# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-06-06 19:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='CompanyInvoice',
            fields=[
                ('persons_company', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='persons.Company', verbose_name='company')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='ContactInvoice',
            fields=[
                ('contact_contact', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='contact.Contact', verbose_name='contact')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alphanumerical_code', models.SlugField(blank=True, default='', help_text='Some local oficial electronic systems handle specific codes for fiscal position types.', max_length=15, verbose_name='alphanumerical code')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, help_text='Certain countries require a fiscal position for its taxpayers.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='contacts', related_query_name='contact', to='invoice.FiscalPosition', verbose_name='fiscal position'),
        ),
        migrations.AddField(
            model_name='companyinvoice',
            name='contacts',
            field=models.ManyToManyField(blank=True, related_name='companies', related_query_name='company', to='contact.Contact', verbose_name='contacts'),
        ),
        migrations.AddField(
            model_name='companyinvoice',
            name='fiscal_addresses',
            field=models.ManyToManyField(blank=True, related_name='_companyinvoice_fiscal_addresses_+', related_query_name='company', to='persons.PhysicalAddress', verbose_name='fiscal addresses'),
        ),
        migrations.AddField(
            model_name='companyinvoice',
            name='fiscal_position',
