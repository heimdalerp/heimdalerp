...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fiscal_position_issuer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', related_query_name='+', to='invoice.FiscalPosition', verbose_name='fiscal position issuer')),
                ('fiscal_position_receiver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', related_query_name='+', to='invoice.FiscalPosition', verbose_name='fiscal position receiver')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='invoice_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', related_query_name='+', to='invoice.InvoiceType', verbose_name='invoice type'),
        ),
        migrations.AddField(
