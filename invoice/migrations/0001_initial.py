    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fiscal_addresses', models.ManyToManyField(blank=True, related_name='_companyinvoice_fiscal_addresses_+', related_query_name='company', to='persons.PhysicalAddress', verbose_name='fiscal addresses')),
            ],
            options={
