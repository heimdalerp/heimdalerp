    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('achievements', models.ManyToManyField(blank=True, related_name='achievements', to='hr.Achievement', verbose_name='achievements')),
                ('aptitudes', models.ManyToManyField(blank=True, related_name='aptitudes', to='hr.Aptitude', verbose_name='aptitudes')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('academic_institution', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hr.AcademicInstitution', verbose_name='academic institution')),
                ('degree', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hr.Degree', verbose_name='degree')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hr.Employee', verbose_name='employee')),
                ('others_implicated', models.ManyToManyField(blank=True, related_name='implicated', to='hr.Employee', verbose_name='others implicated')),
            ],
            options={
                'default_permissions': ('view', 'add', 'change', 'delete'),
                'verbose_name': 'employee has degree',
        ...
        migrations.AddField(
            ...
            name='language',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hr.Language', verbose_name='language'),
        ),
        migrations.AddField(
            model_name='employeehassanction',
            name='sanction',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hr.Sanction', verbose_name='sanction'),
        ),
        migrations.AddField(
            model_name='employeehassanction',
            name='victims',
            field=models.ManyToManyField(blank=True, related_name='victims', to='hr.Employee', verbose_name='victims'),
        ),
        migrations.AddField(
            model_name='employee',
            name='ethnicities',
            field=models.ManyToManyField(blank=True, help_text='Relevant for countries where one must comply quotas', related_name='ethnicities', to='hr.Ethnicity', verbose_name='ethnicities'),
        ),
        migrations.AddField(
            model_name='employee',
            name='extra_emails',
            field=models.ManyToManyField(blank=True, to='persons.ExtraEmailAddress', verbose_name='extra email addresses'),
        ),
        migrations.AddField(
            model_name='employee',
            name='phone_numbers',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, help_text='Relevant for countries where one must comply quotas', null=True, on_delete=django.db.models.deletion.CASCADE, to='hr.SexualOrientation', verbose_name='sexual orientation'),
        ),
        migrations.AddField(
            model_name='employee',
            name='user',
