# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2016-11-21 17:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('when_it_happened', models.DateField(blank=True, help_text='Not necessarily the current date.', null=True, validators=[common.validators.date_is_present_or_past], verbose_name='when it happened')),
                ('points', models.DecimalField(decimal_places=2, default=0.0, max_digits=5, verbose_name='points')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_since', models.DateField(blank=True, null=True, validators=[common.validators.date_is_present_or_past], verbose_name='date since')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.ForeignKey(db_index=False, on_delete=django.db.models.deletion.PROTECT, related_name='+', related_query_name='+', to='hr.Degree', verbose_name='degree')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('when_it_happened', models.DateTimeField(help_text='Not necessarily the current date', validators=[common.validators.date_is_present_or_past], verbose_name='when it happened')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='+', related_query_name='+', to='hr.Employee', verbose_name='employee')),
        ...
        migrations.AddField(
            ...
            name='sanction',
            field=models.ForeignKey(db_index=False, on_delete=django.db.models.deletion.PROTECT, related_name='+', related_query_name='+', to='hr.Sanction', verbose_name='sanction'),
        ),
        migrations.AddField(
            model_name='employeehassanction',
            name='victims',
        ...
        migrations.AddField(
            model_name='employee',
            name='home_address',
            field=models.ForeignKey(blank=True, db_index=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', related_query_name='+', to='persons.PhysicalAddress', verbose_name='home address'),
        ),
        migrations.AddField(
            model_name='employee',
            name='languages',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, db_index=False, help_text='Relevant for countries where one must comply quotas', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='employees', related_query_name='employee', to='hr.SexualOrientation', verbose_name='sexual orientation'),
        ),
        migrations.AddField(
            model_name='employee',
            name='user',
