# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2016-02-17 23:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('achievements', models.ManyToManyField(blank=True, to='hr.Achievement', verbose_name='achievements')),
                ('aptitudes', models.ManyToManyField(blank=True, to='hr.Aptitude', verbose_name='aptitudes')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hr.Employee', verbose_name='employee')),
                ('others_implicated', models.ManyToManyField(related_name='implicated', to='hr.Employee')),
            ],
            options={
                'verbose_name_plural': 'employees have degrees',
                'default_permissions': ('view', 'add', 'change', 'delete'),
        ...
        migrations.AddField(
            model_name='employeehassanction',
            name='victims',
            field=models.ManyToManyField(related_name='victims', to='hr.Employee'),
        ),
        migrations.AddField(
            model_name='employee',
            name='ethnicities',
            field=models.ManyToManyField(blank=True, help_text='Relevant for countries where one must comply quotas', related_name='ethnicities', to='hr.Ethnicity'),
        ),
        migrations.AddField(
            model_name='employee',
            name='extra_emails',
