# -*- coding: utf-8 -*-
# Generated by Django 1.9.4 on 2016-03-10 21:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='invoice.Product')),
            ],
            options={
                'default_permissions': ('view', 'add', 'change', 'delete'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clients', models.ManyToManyField(related_name='quotations', related_query_name='quotation', to='invoice.Client', verbose_name='clients')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quotation_lines', related_query_name='quotation_line', to='sales.ProductSales', verbose_name='product')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total', models.DecimalField(decimal_places=2, default=0.0, help_text='Subtotal plus taxes.', max_digits=12, verbose_name='total')),
                ('notes', models.TextField(blank=True, default='', verbose_name='notes')),
                ('clients', models.ManyToManyField(related_name='sales', related_query_name='sale', to='invoice.Client', verbose_name='clients')),
