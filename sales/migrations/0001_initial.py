    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('persons_company', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='product_categories', related_query_name='product_category', to='persons.Company', verbose_name='company')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('persons_company', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='quotations', related_query_name='quotation', to='persons.Company', verbose_name='company')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='quotation_lines', related_query_name='quotation_line', to='invoice.Product', verbose_name='product')),
                ('product_vat_override', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='quotation_lines', related_query_name='quotation_line', to='invoice.VAT', verbose_name='VAT override')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('persons_company', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='sales', related_query_name='sale', to='persons.Company', verbose_name='company')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_discount', models.FloatField(blank=True, default=0.0, help_text='A number between 0.00 and 1.00', verbose_name='product discount')),
                ('quantity', models.PositiveIntegerField(default=1, verbose_name='quantity')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='sale_lines', related_query_name='sale_line', to='sales.ProductSales', verbose_name='product')),
                ('product_vat_override', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='sale_lines', related_query_name='sale_line', to='invoice.VAT', verbose_name='VAT override')),
            ],
            options={
